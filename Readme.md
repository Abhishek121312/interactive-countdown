# 🎯 Interactive Countdown Timer with Particle Effects
...
- 🎆 Interactive particle effects on click/touch
- 🌊 Ripple animation on user interaction
- 📱 Responsive design
...
## 🔧 Configuration
To change the target date, edit this in `script.js`:

```js
const TARGET_ISO = "2028-07-14T16:00:00";